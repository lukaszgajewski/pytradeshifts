...
nutri_data = pd.read_excel(
    "data/preprocessed_data/integrated_model/from_IM/ALLFED Food consumption, supplies and balances.xlsx",
...
nutri_data = nutri_data[nutri_data["Outdoor growing?"] == 1.0].reset_index(drop=True)
